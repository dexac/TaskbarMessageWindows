...
namespace SystemTrayMessage.Partials
{
    /// <summary>
    /// Util and extension methods.
    /// </summary>
#pragma warning disable
    internal static class UPath
    {
        ...
        public static bool WriteIconData(ref NotifyIconData data, NotifyCommand command, IconDataMembers flags)
        {
            ...
            lock (SyncRoot)
            {
                return WinDLL.Shell_NotifyIcon(command, ref data);
            }
        }
        ...
        /// <summary>
        /// Gets a <see cref="EnmFlags"/> enum value that
        /// matches a given <see cref="BalloonIcon"/>.
        /// </summary>
        public static EnmFlags GetBalloonFlag(this BalloonIcon icon)
        {
            switch (icon)
            {
                case BalloonIcon.None:
                    return EnmFlags.None;
                case BalloonIcon.Info:
                    return EnmFlags.Info;
                case BalloonIcon.Warning:
                    return EnmFlags.Warning;
                case BalloonIcon.Error:
                    return EnmFlags.Error;
                default:
        ...
        public static Icon ToIcon(this ImageSource imageSource)
        {
            ...
            Size iconSize = SystemInfo.SmallIconSize;
        ...
        /// <summary>
        /// Checks if a given <see cref="PopupShow"/> is a match for
        /// an effectively pressed mouse button.
        /// </summary>
        public static bool IsMatch(this MouseEvent me, PopupShow activationMode)
        {
            switch (activationMode)
            {
                case PopupShow.LeftClick:
                    return me == MouseEvent.IconLeftMouseUp;
                case PopupShow.RightClick:
                    return me == MouseEvent.IconRightMouseUp;
                case PopupShow.LeftOrRightClick:
                    return me.Is(MouseEvent.IconLeftMouseUp, MouseEvent.IconRightMouseUp);
                case PopupShow.LeftOrDoubleClick:
                    return me.Is(MouseEvent.IconLeftMouseUp, MouseEvent.IconDoubleClick);
                case PopupShow.DoubleClick:
                    return me.Is(MouseEvent.IconDoubleClick);
                case PopupShow.MiddleClick:
