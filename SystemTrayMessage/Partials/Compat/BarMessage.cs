...
{
    /// <summary>
    /// This contains the logic to access the location of bar and communicate with it.
    /// </summary>
#pragma warning disable
    public class BarMessage
    {
        ...
        /// <summary>
        /// Update location of the bar with the specified classname and win name.
        /// </summary>
        /// <param name="strCName">string</param>
        /// <param name="strWinName">string</param>
        public void GetPosition(string strCName, string strWinName)
        {
            m_data = new APPBARDATA();
            m_data.cbSize = (uint)Marshal.SizeOf(m_data.GetType());

            IntPtr hWnd = FindWindow(strCName, strWinName);
